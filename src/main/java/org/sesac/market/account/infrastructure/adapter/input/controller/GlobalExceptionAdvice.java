...
import org.sesac.market.account.infrastructure.adapter.output.messaging.producer.ProblemDetailCreator;
...
public class GlobalExceptionAdvice extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleBizException(BizException ex, HttpServletRequest request) {
